...
<header>
	<nav class="navbar navbar-expand-md navbar-dark fixed-top" style="background-color: #00b500;">
		<a class="navbar-brand" href="<c:url value="/"/>">SFE</a>
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			...
			<%-- 	<li class="nav-item"><a class="nav-link"
					href="<c:url value="/fireSensors"/>">SensorValue</a></li>
			--%>
			
					<li class="nav-item"><a class="nav-link"	
					href="<c:url value="/location"/>">location</a></li>
				<%-- <li class="nav-item"><a class="nav-link"
